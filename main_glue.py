...
class DataTrainingArguments:
    ...
    cuda_device: int = field(
        default=0,
        metadata={"help": "Cuda device number"},
    )
...
class ModelArguments:
    ...
    init_sigma: float = field(
        default=0.00001, metadata={"help": "sigma used for weights initialization"}
    )
...
def main():
    ...
    find_and_initialize(
        ...
        sigma_val=model_args.init_sigma
    )
    ...
    if task_name == 'cola':
        ...
        performance = metrics['eval_pearson']
    else:
    ...
    df = pd.DataFrame({ 'Method': [method_name],\
                        ...
                        'LoRA Rank':[model_args.lora_rank],\
                        'LoRA Alpha':[model_args.lora_alpha],\
                        'Sigma':[model_args.init_sigma],\
                        'Training_Epochs':[training_args.num_train_epochs],\
                        'Learning_Rate': [training_args.learning_rate],\
                        'Classifier Learning Rate':[model_args.cls_learning_rate],\
